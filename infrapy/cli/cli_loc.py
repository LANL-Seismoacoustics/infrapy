...
def run_loc(config_file, local_event_label, local_loc_label, back_az_width, range_max, resolution, src_est, pgm_file):
    '''
    ...
    if type(events[0]) is list:
        ...
        for j, det_list in enumerate(events):
            ...
            click.echo("Writing localization result into " + local_loc_label + "loc-" + str(j + 1) + ".json")
